...
**Feature design options:** - **Risk/return** factors (e.g., momentum, value, size, quality, low-vol) - **Return correlations** over rolling windows - **Volatility / beta / drawdown** statistics
