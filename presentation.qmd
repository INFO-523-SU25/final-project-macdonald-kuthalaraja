...
# ---- Side-by-side layout ----
fig, axes = plt.subplots(1, 2, figsize=(22, 7.5))

# Left: cluster profiles heatmap
im = axes[0].imshow(centers.values, aspect='auto')
axes[0].set_xticks(range(centers.shape[1]))
axes[0].set_xticklabels(centers.columns, fontsize=11)
axes[0].set_yticks(range(centers.shape[0]))
axes[0].set_yticklabels([f"C{c}" for c in centers.index], fontsize=11)
axes[0].set_title("Cluster Profiles (feature z-scores)", fontsize=14)
...
mix.plot(kind='bar', stacked=True, ax=axes[1], width=0.85)
axes[1].set_title("Sector Mix within Clusters (%)", fontsize=14)
axes[1].set_xlabel("Cluster", fontsize=12)
axes[1].set_ylabel("Percent of names", fontsize=12)
axes[1].legend(bbox_to_anchor=(0.5, -0.25), loc="upper center",
               ncol=4, frameon=False, fontsize=9, title="Sector")
